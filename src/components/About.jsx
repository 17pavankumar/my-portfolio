                ...
                <div className="about__data">
                    ...
                    <div className="about__info">
                        <div>
                            ...
                            <span className="about__info-name">Full Stack Dev <br /> @ Varcons</span>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <span class="about__info-name">7.76 <br /> / 10</span>
                        </div>
                    </div>

                    <div className="about__buttons">
                        <a href="/assets/Pavan_Kumar_Resume.png" target="_blank" rel="noopener noreferrer" className="button button--ghost">
                            View Resume <i className="fa-regular fa-file-lines button__icon"></i>
                        </a>
                    </div>
                </div>
            </div>
